<header class="header header_menu " style="color: white !important;">
    <div class="mid-header wid_100 d-flex align-items-center">
        <div class="container ">
                ...
                <div class="col-2 col-lg-2 col-xl-2 header-left tuan-a">
                    <a href="{{ route('home') }}" class="logo-wrapper d-sm-none a2" title='{{ $setting->company }}'>
                        <img loading="lazy" class="img-fluid logo-top-tuan" src="{{ $setting->logo }}"
                            alt="{{ $setting->company }}" width="800" height="200"
                    ...
                    <a href="{{ route('home') }}" class="logo-wrapper d-none d-sm-block"
                ...
                <div class="col-5 header_phone col-lg-6 col-xl-5 pl-0">
                    <ul class="header-right mb-0 list-unstyled d-flex align-items-center">
                        <li class="media d-sm-flex d-none hotline">
                            ...
                            <img src="{{ asset('frontend/images/icons8-phone-50.png') }}" width="24" height="24"
                                class="mr-3 align-self-center" alt="phone-icon">
                        ...
                        <li class='ml-md-3 media d-lg-flex d-none hotline'>
                            <img loading="lazy" src="{{ asset('frontend/images/icons8-contact-48.png') }}"
                        ...
                        @if (Auth::guard('customer')->check())
                            <li class="ml-4 mr-4 mr-md-0 ml-md-3 media d-lg-flex d-none">
                                <img src="{{ asset('frontend/images/icons8-user-50.png') }}" width="24"
                                    height="24" alt="account_icon" class="  mr-3 align-self-center">
                                <div class="media-body d-md-flex flex-column d-none ">
                        ...
                        @else
                            <li class='ml-4 mr-4 mr-md-0 ml-md-3 media d-lg-flex d-none'>
                                <img loading="lazy" src="{{ asset('frontend/images/icons8-user-50.png') }}"
                                    width="24" height="24" alt="account_icon"
                                    class="  mr-3 align-self-center" />
                                <div class="media-body d-md-flex flex-column d-none ">
                                    <a rel="nofollow" href="{{ route('login') }}" class="d-block"
                                        title="Tài khoản">
                                        Tài khoản
                                    </a>
                                    <small>
                        ...
                        <li class="cartgroup ml-3">
                            <div class="mini-cart text-xs-center d-none d-sm-block">
                                <a class="img_hover_cart" href="{{ route('listCart') }}" title="Giỏ hàng">
                                    <img loading="lazy" src="{{ asset('frontend/images/icons8-cart-48.png') }}"
            ...
            <div class="row">
                <div class="col-2"></div>
                <div class="menu_hd col-lg-10 col-12 dichuyen-menu">
                    <ul>
...
window.addEventListener('scroll', function() {
    var menu = document.querySelector('.menu_hd');
    if (!menu) return;
    if (window.scrollY > 200) {
        menu.classList.remove('dichuyen-menu');
        menu.classList.add('menu-scroll');
    } else {
        menu.classList.add('dichuyen-menu');
