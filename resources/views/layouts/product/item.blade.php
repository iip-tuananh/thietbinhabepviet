...
// dd($pro);
    ...
    $phantram = $pro['price'] > 0 ? 100 - ($pro['discount'] / $pro['price']) * 100 : 0;
@endphp
<div class="flashsale__item col-12 col-lg-15 item " data-pd-id="1053774514" data-inventory-quantity="" data-available="true"
    data-max-stock="100">
                                        ...
                                        <div class="product-promotion rounded-sm mb-3" id="qv-ega-salebox">
                                            <h3
                                                ...
                                                <img alt="KHUYẾN MÃI - ƯU ĐÃI"
                                                    src="{{ asset('frontend/images/icon-product-promotion.png') }}"
