...
<body>
    ...
    {{-- @foreach ($homePro as $pro)
        <div class="flashsale__item col-12 col-lg-15" data-pd-id="1053774514" data-inventory-quantity=""
            data-available="true" data-max-stock="100">
            <div class="item_product_main">
                <form action="/cart/add" method="post" class="variants product-action"
                    data-id="product-actions-1053774514" enctype="multipart/form-data">
                    <div class="product-thumbnail pos-relative">
                        <a class="image_thumb pos-relative embed-responsive embed-responsive-1by1"
                            href="/products/smart-tivi-samsung-4k-55-inch-ua55du8000"
                            title="{{$item->name}}">
                            <img loading="lazy"
                                ...
                                data-src="//product.hstatic.net/200000574527/product/du8000_dea2f984c4f247138f9eb6982026e956_large.jpg"
                                alt="{{$item->name}}">
                            <img loading="lazy"
                                class='product-thumbnail__img product-thumbnail__img--secondary lazyload'
                                width="480" height="480" style="--image-scale: 1;"
                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                data-src="//product.hstatic.net/200000574527/product/du8000-1_8d25e7a121c54e81bb0d0ff8f31cf3ac_large.jpg"
                                alt="{{$item->name}}">
                        </a>
                        ...
                        <div class="product-action">
                            <div class="group_action"
                                data-url="/products/smart-tivi-samsung-4k-55-inch-ua55du8000">
                                <a title="Xem nhanh"
                                    href="/products/smart-tivi-samsung-4k-55-inch-ua55du8000"
                                    data-handle="smart-tivi-samsung-4k-55-inch-ua55du8000"
                    ...
                    <div class="product-uudai-wrapper">
                        <div class="product-uudai-img">
                            <img class="lazyload"
                                src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                                data-src="//theme.hstatic.net/200000574527/1001200251/14/img_tag_uudai_3.png?v=443" />
                        </div>
                    </div>
                    <div class="product-info">
                        <h3 class="product-name"><a
                                href="/products/smart-tivi-samsung-4k-55-inch-ua55du8000"
                                title="{{$item->name}}">Smart
                                {{$item->name}}</a></h3>
                        ...
                        <div class='product-promotion hidden' id='ega-salebox-1053774514'>
                            <h3
                            ...
                            <ul class="promotion-box">
                                ...
                                <li><a
                                        href="https://sgt.com.vn/blogs/news/chuong-trinh-ho-tro-tra-gop-0-lai-suat"><span
                                            style="font-size:16px">Chương trình của hãng Trả góp lãi
                                            suất <strong><span style="color:#e74c3c">0%</span></strong>,
                                            duyệt hồ
                                            sơ nhanh trong 5 phút </span><span
                                            style="font-size:12px">&lt;Chỉ áp dụng với Sản phẩm TV, Tủ
                                            lạnh, Máy giặt, Điều hòa của LG và Samsung&gt;</span></a>
                                </li>
                                <li>Bảo hành chính hãng tại nhà theo tiêu chuẩn của nhà sản xuất</li>
                                <li>Quý khách là đại lý, nhà thầu, thợ cần hỗ trợ số lượng lớn, xin vui
                                    lòng liên hệ tổng đài bán hàng: <a
                                        href="tel:02422665858">024.2266.5858</a></li>
                                <li>Giá bán tại kho (chưa bao gồm phí vận chuyển và lắp đặt)
                                    <a target="_blank"
                                        href="https://sgt.com.vn/pages/chinh-sach-van-chuyen-va-lap-dat-sgt"><br><i><u>Chính
                                                Sách Vận Chuyển - Lắp Đặt SGT</u></i><br></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="product-info">
                    ...
                    <div class='product-promotion hidden' id='ega-salebox-1054370102'>
                        ...
                        <ul class="promotion-box">
                            ...
                            <li><a href="https://sgt.com.vn/blogs/news/chuong-trinh-ho-tro-tra-gop-0-lai-suat"><span
